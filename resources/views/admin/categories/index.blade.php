                        ...
                        <tr class="hover:bg-gray-300 dark:hover:bg-[#262c47]">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center space-x-3">
                                    <!-- View Button -->
                                    <a href="{{ route('admin.categories.show', $category) }}" class="inline-flex items-center text-indigo-600 dark:text-indigo-300 hover:text-indigo-900 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-[#23263a] px-2 py-1 rounded transition-colors duration-200" title="View Category">
                                    ...
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.categories.edit', $category) }}" class="inline-flex items-center text-amber-600 dark:text-amber-300 hover:text-amber-900 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-[#23263a] px-2 py-1 rounded transition-colors duration-200" title="Edit Category">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $category) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="inline-flex items-center text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-[#23263a] px-2 py-1 rounded transition-colors duration-200" title="Delete Category" onclick="return confirm('Are you sure you want to delete this category?')">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
