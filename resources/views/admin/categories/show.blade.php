...
<div class="max-w-3xl mx-auto space-y-8 bg-gray-300 dark:bg-[#181f31] min-h-screen p-8">
    ...
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 flex flex-col md:flex-row gap-6 border border-gray-100 dark:border-[#23263a]">
        ...
        <div class="flex-1 space-y-3">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ $category->name }}</h3>
            <div>
            ...
            <div>
                ...
                <span class="text-indigo-700 dark:text-indigo-300 font-semibold">{{ $category->products_count ?? $category->products()->count() }}</span>
            </div>
            <div>
