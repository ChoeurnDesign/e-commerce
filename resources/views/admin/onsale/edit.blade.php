...
@section('title', 'Edit On Sale Product')
@section('content')
<div class="max-w-lg mx-auto bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-100 dark:border-gray-600 mt-10">
    ...
    <form action="{{ route('admin.onsale.update', ['product' => $product->id]) }}" method="POST">
        ...
        <div class="pt-4 flex space-x-4">
            ...
            <a href="{{ route('admin.onsale.index') }}" class="bg-gray-300 dark:bg-[#23263a] hover:bg-gray-400 dark:hover:bg-[#262c47] text-gray-800 dark:text-gray-200 px-6 py-2 rounded-lg font-semibold transition duration-200">
                Cancel
            </a>
        </div>
    </form>
