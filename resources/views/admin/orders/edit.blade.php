...
@section('content')
<div class="max-w-3xl mx-auto space-y-8 bg-gray-300 dark:bg-[#181f31] min-h-screen p-8">
    <!-- Header -->
    ...
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-100 dark:border-[#23263a]">
        <form action="{{ route('admin.orders.update', $order) }}" method="POST" class="space-y-6">
            ...
            <div class="pt-4 flex space-x-4">
                ...
                <a href="{{ route('admin.orders.index') }}" class="bg-gray-300 dark:bg-[#23263a] hover:bg-gray-400 dark:hover:bg-[#262c47] text-gray-800 dark:text-gray-200 px-6 py-2 rounded-lg font-semibold transition duration-200">
                    Cancel
                </a>
            </div>
        </form>
