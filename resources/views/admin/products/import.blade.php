...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-[#23263a] shadow-xl rounded-xl overflow-hidden p-8 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Import Products</h1>
        </div>
        ...
        <form action="{{ route('admin.products.import') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a href="{{ route('admin.products.index') }}" class="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-300 transition">Back to Products</a>
            </div>
        </form>
