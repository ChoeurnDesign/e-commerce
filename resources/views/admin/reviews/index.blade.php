...
<div class="p-8 bg-gray-300 dark:bg-[#181f31] min-h-screen">
    <div class="mb-6 flex items-center">
        <span class="mr-2">
            <svg class="w-7 h-7 text-indigo-600 dark:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.967a1 1 0 00.95.69h4.18c.969 0 1.371 1.24.588 1.81l-3.385 2.46a1 1 0 00-.364 1.118l1.287 3.966c.3.922-.755 1.688-1.54 1.118l-3.385-2.46a1 1 0 00-1.175 0l-3.385 2.46c-.784.57-1.838-.196-1.54-1.118l1.287-3.966a1 1 0 00-.364-1.118l-3.385-2.46c-.783-.57-.38-1.81.588-1.81h4.18a1 1 0 00.95-.69l1.286-3.967z"/>
            </svg>
        </span>
                ...
                <tbody>
                    @forelse ($reviews as $review)
                        <tr class="hover:bg-indigo-50 dark:hover:bg-[#2a3350] transition">
                            <td class="px-6 py-4 border-b border-gray-100 dark:border-[#23263a] text-center text-gray-900 dark:text-gray-100 font-semibold">
                                {{ $loop->iteration }}
                            </td>
