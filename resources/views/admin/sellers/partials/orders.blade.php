                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-[#232c47]">
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-block px-2 py-1 rounded-full text-xs
                                @if($order->status === 'pending') bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300
                                @elseif($order->status === 'completed') bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300
