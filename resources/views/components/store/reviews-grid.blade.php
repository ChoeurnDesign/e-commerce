...
<script>
    ...
    function updateReview(event, reviewId) {
        ...
        const updateUrlTemplate = "{{ route('seller.reviews.update', ['review' => ':id']) }}";
        const url = updateUrlTemplate.replace(':id', reviewId);

        fetch(url, {
            method: 'POST', // formData contains _method=PUT (from @method('PUT')), so POST is fine
            body: formData,
            headers: {
    ...
    function deleteReview(reviewId) {
        if (confirm('Are you sure you want to delete this review?')) {
            const deleteUrlTemplate = "{{ route('seller.reviews.destroy', ['review' => ':id']) }}";
