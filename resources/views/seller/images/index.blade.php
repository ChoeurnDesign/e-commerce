...
@section('title', 'Seller Product Images')
...
<div class="container mx-auto py-8 space-y-8">
    ...
    <div class="bg-white dark:bg-[#23263a] rounded-xl border border-gray-200 dark:border-[#2b3150] p-6 space-y-6">
        ...
        <form action="{{ route('seller.images.uploadMain') }}" method="POST" enctype="multipart/form-data" class="flex flex-col sm:flex-row items-start gap-3">
            @csrf
    ...
    <div class="bg-white dark:bg-[#23263a] rounded-xl border border-gray-200 dark:border-[#2b3150] p-6 space-y-6">
        ...
        <form action="{{ route('seller.images.uploadGallery') }}" method="POST" enctype="multipart/form-data" class="flex flex-col sm:flex-row items-start gap-3">
            @csrf
    ...
    {{-- Grids --}}
    <x-images.grid title="Main Images" :images="$mainImages" delete-route="seller.images.delete" />

    <x-images.grid title="Gallery Images" :images="$galleryImages" delete-route="seller.images.delete" />
</div>
@endsection 