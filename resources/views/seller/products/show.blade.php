...
<div class="max-w-full mx-auto space-y-8">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('seller.products.index') }}" class="bg-gray-300 dark:bg-[#23263a] hover:bg-gray-300 dark:hover:bg-[#262c47] text-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg transition duration-200">
    ...
    <div class="flex space-x-4">
        <a href="{{ route('seller.products.edit', $product) }}" class="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-lg transition duration-200">Edit Product</a>
