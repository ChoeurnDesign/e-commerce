            ...
            <table class="min-w-full rounded-xl overflow-hidden border-separate border-spacing-y-2">
                ...
                <tbody>
                    ...
                    <tr class="bg-[#23263a] hover:bg-[#262941] transition-all duration-150 rounded-lg shadow-sm">
                        <td class="px-5 py-4 text-white"><?php echo e($loop->iteration); ?></td>
                        <td class="px-5 py-4 text-white font-semibold"><?php echo e($product->name); ?></td>
                        ...
                        <td class="px-5 py-4 text-center">
                            <div class="flex justify-center gap-4">
                                <a href="<?php echo e(route('admin.onsale.edit', ['product' => $product->id])); ?>"
                                ...
                                <form action="<?php echo e(route('admin.products.removeFromSale', $product->id)); ?>" method="POST" class="inline"
