...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 text-blue-400 flex-shrink-0']); ?>
...
<?php endif; ?>
                    <a href="mailto:<?php echo e($seller->contact_email); ?>" class="hover:underline break-words text-gray-700 dark:text-gray-100"><?php echo e($seller->contact_email); ?></a>
                </li>
            <?php endif; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <address class="not-italic break-words text-gray-700 dark:text-gray-100"><?php echo e($seller->address); ?></address>
                </li>
            <?php endif; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <a href="tel:<?php echo e($seller->phone); ?>" class="hover:underline text-gray-700 dark:text-gray-100"><?php echo e($seller->phone); ?></a>
                </li>
            <?php endif; ?>
        </ul>
    </section>
    ...
    <section class="mt-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            <?php $__currentLoopData = $platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $url = $socials[$p] ?? null; ?>
                <?php if(!$url): ?> <?php continue; ?> <?php endif; ?>
                ...
                <a href="<?php echo e($url); ?>" target="_blank" rel="noopener noreferrer"
                   ...
                   aria-label="<?php echo e($labelFor($p)); ?> profile"
                   title="<?php echo e($url); ?>">
                    ...
                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-full flex-shrink-0 shadow-inner ring-1 ring-white/5 group-hover:scale-105 transition-transform duration-150
                                 <?php echo e($badgeClasses[$p] ?? 'bg-gray-800 dark:bg-gray-700'); ?>">
                        <?php if($hasIcon($p)): ?>
                            <img src="<?php echo e(asset('icons/social/' . $p . '.svg')); ?>" alt="<?php echo e($p); ?> icon" class="w-5 h-5"/>
                        <?php else: ?>
                            <?php echo view('components.icon-socials', ['name' => $p, 'class' => 'text-white', 'bare' => true])->render(); ?>
                    ...
                    <div class="min-w-0">
                        <div class="flex items-center gap-2">
                            <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($labelFor($p)); ?></span>
                            <span class="text-xs text-gray-500 dark:text-gray-400">•</span>
                            <span class="text-xs text-gray-400 dark:text-gray-300"><?php echo e($shortDomain($url)); ?></span>
                        </div>
                        <div class="text-sm text-gray-500 dark:text-gray-400 truncate max-w-full">
                            <?php echo e(Str::limit($url, 60)); ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $seller)): ?>
...
</div><?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/stores/partials/contact-info.blade.php ENDPATH**/ ?>