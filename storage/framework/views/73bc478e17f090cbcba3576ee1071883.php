<header class="bg-gray-800 dark:bg-[#23263a] shadow-sm border-b border-gray-300 dark:border-[#23263a] transition-colors">
    <div class="flex justify-between items-center px-6 py-4">
        <div class="flex items-center">
            ...
            <h1 class="text-2xl text-gray-300 dark:text-gray-100"><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?></h1>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="max-w-xs flex items-center text-sm rounded-full transition-colors">
                    ...
                    <span class="hidden lg:block ml-2 text-gray-300 dark:text-gray-100 font-medium"><?php echo e(auth()->user()->name); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('profile.edit'),'class' => 'flex items-center text-gray-300 dark:text-gray-100 hover:bg-gray-300 dark:hover:bg-[#262c47]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit')),'class' => 'flex items-center text-gray-300 dark:text-gray-100 hover:bg-gray-300 dark:hover:bg-[#262c47]']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('home')),'class' => 'flex items-center text-gray-300 dark:text-gray-100 hover:bg-gray-300 dark:hover:bg-[#262c47]']); ?>
                            <?php if (isset($component)) { $__componentOriginald9467a222f025bb28cc0dfbd8d0ecdd8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald9467a222f025bb28cc0dfbd8d0ecdd8 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                            ...
                            <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('logout'),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex items-center text-red-600 dark:text-red-400 hover:text-orange-600 dark:hover:text-orange-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex items-center text-red-600 dark:text-red-400 hover:text-orange-600 dark:hover:text-orange-400']); ?>
                                <?php if (isset($component)) { $__componentOriginald9467a222f025bb28cc0dfbd8d0ecdd8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald9467a222f025bb28cc0dfbd8d0ecdd8 = $attributes; } ?>
