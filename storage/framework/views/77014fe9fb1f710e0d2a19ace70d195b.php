...
<div class="max-w-full mx-auto space-y-8">
    ...
    <div class="flex space-x-4">
        <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-lg transition duration-200">Edit Product</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/admin/products/show.blade.php ENDPATH**/ ?>