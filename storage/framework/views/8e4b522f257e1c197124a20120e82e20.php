...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('next-step-btn').onclick = function() {
        // You can add validation before going to next step here!
        ...
        createOrder: function(data, actions) {
            return actions.order.create({
                purchase_units: [{
                    ...
                    amount: { value: '541.42' } // Use real total here
                }]
            });
        },
...
<?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/checkout/script.blade.php ENDPATH**/ ?>