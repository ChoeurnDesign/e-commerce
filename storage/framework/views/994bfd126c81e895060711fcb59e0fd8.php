        ...
        <div class="flex gap-4 mt-4 items-center">
            <?php if(auth()->guard()->check()): ?>
                ...
                <button onclick="event.stopPropagation(); toggleWishlist(<?php echo e($product->id); ?>, this)"
                    type="button"
                    class="wishlist-btn border border-gray-400 dark:border-gray-700 shadow transition-all p-0 rounded-full flex items-center justify-center w-10 h-10 <?php echo e(auth()->user()->hasInWishlist($product->id) ? 'text-red-500' : 'text-gray-400 dark:text-gray-500 hover:border-red-400 dark:hover:border-red-400'); ?>"
                    data-product-id="<?php echo e($product->id); ?>"
