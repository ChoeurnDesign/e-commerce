<div class="max-w-full mx-auto">
    <div class="bg-white dark:bg-[#23263a] shadow-xl rounded-xl overflow-hidden p-8 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($title ?? 'Import Products'); ?></h1>
        </div>

        <ol class="list-decimal list-inside mb-8 text-gray-700 dark:text-gray-200">
            <li>Download the <a href="<?php echo e(asset('sample-products-template.csv')); ?>" class="text-indigo-600 dark:text-indigo-300 underline">sample CSV template</a>.</li>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between mt-4">
                <button type="submit"
                    ...
                    <?php echo e($buttonText ?? 'Import Products'); ?>

                </button>
                <a href="<?php echo e($backRoute); ?>" class="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-300 transition">Back to Products</a>
            </div>
        </form>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/products/partials/import_form.blade.php ENDPATH**/ ?>