<div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 sticky top-4">
    ...
    <div class="space-y-2 text-sm mb-4">
        <div class="flex justify-between">
            <span class="text-gray-600 dark:text-gray-400">Subtotal (<?php echo e($cartTotals['total_quantity']); ?> items)</span>
    ...
    <?php if(auth()->guard()->check()): ?>
        <a href="<?php echo e(route('checkout.index')); ?>" class="block w-full bg-green-600 hover:bg-green-700 text-white font-bold py-2 rounded-full transition duration-300 text-center shadow">
            Checkout
        </a>
    <?php else: ?>
        <div class="space-y-2 mb-3">
            ...
            <div class="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0">
                <a href="<?php echo e(route('login')); ?>" class="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-2 rounded-lg transition text-center shadow">Login</a>
                <a href="<?php echo e(route('register')); ?>" class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 rounded-lg transition text-center shadow">Create Account</a>
            </div>
        </div>
    <?php endif; ?>
    <div class="mt-5 pt-5 border-t border-gray-200 dark:border-gray-700 text-xs text-gray-600 dark:text-gray-400 space-y-1">
        ...
        <div class="flex items-center gap-1">
            <svg class="w-4 h-4 text-green-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            <span>Free shipping over <?php echo e(\App\Helpers\CurrencyHelper::format(50)); ?></span>
        </div>
        <div class="flex items-center gap-1">
            <svg class="w-4 h-4 text-green-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
...
<?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/cart/partials/summary.blade.php ENDPATH**/ ?>