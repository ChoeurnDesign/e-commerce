...
>
    ...
    <?php if(isset($unreadCount) && $unreadCount > 0): ?>
        <!-- Corrected notification badge for better centering -->
            ...
            <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('admin.reports.show', $report->id)); ?>"
                   class="block px-4 py-2 text-gray-700 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-[#262c47] transition-colors">
                    <div class="font-medium truncate"><?php echo e($report->title); ?></div>
                    <div class="text-xs text-gray-400"><?php echo e($report->created_at->diffForHumans()); ?></div>
                </a>
