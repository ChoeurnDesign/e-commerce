        ...
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">
                    $<?php echo e(number_format($stats['total_sales'], 2)); ?>
    ...
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e(number_format($stats['total_orders'])); ?></p>
            </div>
        </div>
    </div>
    <!-- Total Users -->
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e(number_format($stats['total_users'])); ?></p>
            </div>
        </div>
    </div>
    <!-- Products -->
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e(number_format($stats['total_products'])); ?></p>
            </div>
        </div>
    </div>
    <!-- Categories -->
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e(number_format($stats['total_categories'])); ?></p>
            </div>
        </div>
    </div>
    <!-- Pending Orders -->
    <div class="bg-white dark:bg-[#23263a] rounded-lg shadow p-6 border border-gray-200 dark:border-[#23263a]">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e(number_format($stats['pending_orders'])); ?></p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/admin/dashboard/_stats.blade.php ENDPATH**/ ?>