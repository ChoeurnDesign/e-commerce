        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="<?php echo e(route('categories.index')); ?>" class="text-gray-300 hover:text-white transition duration-150 ease-in-out">Categories</a></li>
                    <li><a href="<?php echo e(route('cart.index')); ?>" class="text-gray-300 hover:text-white transition duration-150 ease-in-out">Shopping Cart</a></li>
                    <?php if(auth()->guard()->check()): ?>
                        <li><a href="<?php echo e(route('orders.history')); ?>" class="text-gray-300 hover:text-white transition duration-150 ease-in-out">My Orders</a></li>
                    <?php endif; ?>
                </ul>
            </div>
...
<?php /**PATH D:\Year III\SemesterII\WCT\ShopExpress\resources\views/layouts/footer.blade.php ENDPATH**/ ?>